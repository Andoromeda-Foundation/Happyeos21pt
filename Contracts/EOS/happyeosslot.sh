...
#/usr/local/eosio/bin/eosiocpp -g happyeosslot/happyeosslot.abi happyeosslot/happyeosslot.cpp 

#cleos -u http://api-direct.eosasia.one get table happyeosslot happyeosslot player
# cleos -u http://api-direct.eosasia.one push action happyeosslot burn '["minakokojimo", "1.0000 HPY"]' -p minakokojima@active

#cleos -u http://api.eosbeijing.one set contract happyeosslot happyeosslot -p happyeosslot@active
...
# 
cleos -u http://api.eosbeijing.one push action happyeosslot test '["minakokojima", "1.0000 HPY"]' -p happyeosslot@active
