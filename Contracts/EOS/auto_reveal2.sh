...
for (( ;1 < 100; ))
do
result=`cleos -u http://api.eosbeijing.one get table happyeosdice happyeosdice offer`
if [ ${#result} -gt 35 ]; then
        # sleep 1s
        cleos wallet unlock --password PW5JaGpLtoM1vtD1WxiAC4RDsr82FRUczmKgocw1KJZqVahB4LZ1u
        last_seed=`cat /Users/minakokojima/Desktop/rawseed.txt`
...
#        echo $seed
        ...
        echo "hash " $hash
        echo `date` >> /Users/minakokojima/Desktop/seed.txt
        echo "seed: " $seed >> /Users/minakokojima/Desktop/seed.txt
        echo "hash: " $hash >> /Users/minakokojima/Desktop/seed.txt
