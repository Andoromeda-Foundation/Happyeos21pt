(module
 ...
 (data (i32.const 32) "next primary key in table is at autoincrement limit\00")
 (data (i32.const 96) "object passed to iterator_to is not in multi_index\00")
 (data (i32.const 160) "g4zdamygenes\00")
 ...
 (data (i32.const 768) "order is not exist.\00")
 (data (i32.const 800) "comparison of assets with different symbols is not allowed\00")
 (data (i32.const 864) "ask is not equal to order bid.\00")
 (data (i32.const 896) "bid is not equal to order ask.\00")
 (data (i32.const 928) "active\00")
 (data (i32.const 944) "transfer\00")
 (data (i32.const 960) "trade success\00")
 ...
 (data (i32.const 1200) "not the owner.\00")
 (data (i32.const 1216) "order retrieve\00")
 (data (i32.const 1232) "invalid token transfer\00")
 (data (i32.const 1264) "must bet a positive amount\00")
 (data (i32.const 1296) "ask\00")
 (data (i32.const 1312) "take\00")
 (data (i32.const 1328) "retrieve\00")
 (data (i32.const 1344) "cleantxlogs\00")
