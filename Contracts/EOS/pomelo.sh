...
cleos -u http://api-direct.eosasia.one get table happyeosslot deasosososos player

# Set Contract
cleos -u https://api-kylin.eosasia.one set contract rukamoemoe51 pomelo -p rukamoemoe51@active

cleos -u https://api-kylin.eosasia.one push action rukamoemoe51 setwhitelist '["PML", "dacincubator"]' -p rukamoemoe51@active

#cleos -u https://api-kylin.eosasia.one push action pomelo rmwhitelist '["PML"]' -p rukamoemoe51@active


#leos -u https://api-kylin.eosasia.one push action eosio.token transfer '[ "minakokojima", "rukamoemoe51", "0.0001 EOS", "" ]' -p minakokojima@active
...
cleos -u https://api-kylin.eosasia.one get table rukamoemoe51 PML whitelist
...
#cleos wallet import --private-key 5JHbgPZXUuA3mp7gZBZVXEdYuJBVumiduvJjKZSEtzc6z1FQY6M